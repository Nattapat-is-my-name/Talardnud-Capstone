...
// tests for EntitiesSlot
void main() {
  // final instance = EntitiesSlot();

  group('test EntitiesSlot', () {
    // List<EntitiesBooking> booking (default value: const [])
    ...
    // String marketId
    test('to test the property `marketId`', () async {
      // TODO
    });
