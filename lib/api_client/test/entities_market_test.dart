...
// tests for EntitiesMarket
void main() {
  // final instance = EntitiesMarket();

  group('test EntitiesMarket', () {
    // String address
    ...
    // String layoutImage
    test('to test the property `layoutImage`', () async {
      // TODO
    });
    ...
    // List<EntitiesSlot> slots (default value: const [])
